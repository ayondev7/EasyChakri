...
import { mockJobs, mockApplications, mockUsers, mockInterviews } from "@/utils/MockData"
import { ArrowLeft, Phone, MapPin, FileText, Download, Eye, Briefcase, AtSign } from "lucide-react"
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center gap-4">
                        <Avatar className="h-20 w-20">
                          <AvatarImage src={applicantUser?.avatar || "/placeholder.svg"} alt={applicantUser?.name} />
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      {applicantUser?.skills?.map((skill, index) => (
                        <Badge key={index} variant="outline" className="bg-cyan-500/10 text-cyan-500 border-cyan-500/20">
                          {skill}
                        </Badge>
                      ))}
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    <div>
                      ...
                      <Select 
                        ...
                        onValueChange={(value) => handleStatusChange(selectedApplicant.id, value as Application["status"])}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        ...
                        <div className="flex flex-col gap-3 md:items-end">
                          <div className="flex items-center gap-2">
                            <Select
                              ...
                              onValueChange={(value) => {
                                handleStatusChange(application.id, value as Application["status"])
                              }}
                            >
